...
Nothing much to tell about the python version. Directly compute the factorial, using recursion and python's native (big) ints. Convert the result to a string, cycle through it digit by digit and add them up. $N = 100$ takes $70 \\, \mu\text{s}$, $N = 1000$ takes $2$ ms.
